...
const Data = () => {
  return (
    <div className='home__data'>
        <h1 className='home__title'>Farhan Ahmed
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className='home__description'>Experienced Web Developer with a demonstrated history of working in the IT industry.
        Skilled in React and React Native. </p>
